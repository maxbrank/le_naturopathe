...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="images/Detox-Diets-For-Weight-Loss.-538x218.jpg" width="538" height="218" alt="Des jus de légumes pour plus de jus">
        </div>
        <div class="col-md-6">
            <p><?= $article['content']; ?></p>
        </div>
            ...
            <div class="comment-wrapper">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form method="POST">
                            <textarea class="form-control" placeholder="laisser un commentaire..." rows="3" name="newContent"></textarea>
